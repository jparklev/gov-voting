...
contract VoteProxyFactory {
    ...
    event HotChanged(address indexed cold, address indexed oldHot, address indexed newHot);
    ...
    function hasProxy(address _guy) public view returns (bool) {
        return (coldMap[_guy] != address(0) || hotMap[_guy] != address(0));
    }
